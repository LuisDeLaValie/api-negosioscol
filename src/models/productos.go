...
func CrearProducto(nombre string, descripcion string, imagen string, unidad int64) (*int64, *ErrorStatusCode) {
	...
	stmt, err := db.Prepare("CALL registrarproducto($1, $2, $3, $4);")
	if err != nil {
		return nil, Error500(err.Error())
	}
	defer stmt.Close()
